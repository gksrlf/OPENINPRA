...
public class WavefrontSaver {
    ...
    public WavefrontSaver(List<Object3DData> objList, String baseName) {
    ...
    public void unpackingArrayBuffer(Object3DData obj) throws Exception {
    ...
    public File OutFileToVertexBuffer(String filePath, float SCALE_MAX) {
        ...
        try {
            ...
            for (Object3DData obj : objList) {
                object3DUnpacker = new Object3DUnpacker(obj);
                faces = obj.getFaces();
                unpackingArrayBuffer(obj);
                ...
                for (int i = 0; i < vertexArrayList.size(); i++) {
                    ...
                    fw.write("v "
                            + String.format(Locale.KOREA, "%.1f", (valX * (obj.getScaleX() * 100 / SCALE_MAX) / 100)) + " "
                            + String.format(Locale.KOREA, "%.1f", (valY * (obj.getScaleY() * 100 / SCALE_MAX) / 100)) + " "
                            + String.format(Locale.KOREA, "%.1f", (valZ * (obj.getScaleZ() * 100 / SCALE_MAX) / 100)) + " "
                            + "\n");
                }
